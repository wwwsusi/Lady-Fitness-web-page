...
export default function WalkPage() {
  return <div className={styles.version}><a className="skip" href="#obsah">Preskočiť na obsah</a><SiteHeader animated /><Walkthrough /><div className={styles.details}><FitnessPage contentOnly /></div></div>;
}
